...
public interface IChatService
{
    ...
    Task<ApiResponse<ChatSessionDto>> CreateSessionAsync(CreateSessionRequest request, int? userId);
    Task<ApiResponse<ChatMessageListResult>> GetMessagesAsync(int sessionId, int page, int size, int? userId);
